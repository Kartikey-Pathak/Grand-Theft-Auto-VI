...
function Info() {
    ...
    return (
        <div ref={box} className=" h-full w-full relative">
            <div ref={box2} className=" absolute top-100 z-[120] border-2 border-red-400 h-screen w-full left-0 right-0">
             
                </div>

                {/* text info part */}

                <div ref={box3} className=" absolute top-280  z-[120] border-2 border-green-500 h-screen w-full left-0 right-0">
      <div ref={textinfo} className={` ${Animation1?"flex":"hidden"} opacity-0 absolute top-2 left-0 right-0 justify-center items-center flex-col gap-10 border-2`}>
            <div className=" flex items-center justify-center flex-col gap-5 h-fit w-[99%]">
            <h1 className=" text-[#9C2C64] text-7xl t">Vice City, USA.</h1>
            <h2 className=" text-[#F07068] text-5xl">Jason and Lucia have always known the deck is stacked against them. But when an easy score goes wrong, they find themselves on the darkest side of the sunniest place in America, in the middle of a criminal conspiracy stretching across the state of Leonida — forced to rely on each other more than ever if they want to make it out alive.</h2>
            </div>
        </div>
                </div>
                ...
                <div ref={box4}  className= " absolute top-300  z-[120] border-2 border-blue-500 h-screen w-full left-0 right-0">
                    <div className=" h-full w-full flex items-center justify-center relative">
                        <div className=" flex items-center justify-start">
                        <div className=" absolute z-[140] h-[100%] flex">
                        <img src="/hero2char.webp" className="h-full w-full object-cover right-0" alt="" />
                        </div>
                        </div>
            ...
            <div ref={intro} className=" sticky top-10 left-0 right-0 flex justify-center items-center opacity-100 flex-col gap-10 border-2">
                ...
                <div ref={txt} className=" opacity-0 flex justify-center items-center h-fit w-[80%] flex-col gap-5 mt-56">
                    <h1 className=" font-bold  text-8xl text-[#E88068]">COMING</h1>

                    <h1 className=" font-bold text-8xl text-[#F0B078]">MAY 26</h1>
