...
function Info() {
    ...
    const [large,setlarge]=useState(false);
        const [large2,setlarge2]=useState(false);
    ...
    useGSAP(() => {
        ...
        gsap.to(intro.current, {
            ...
            onLeaveBack: () => {
                setlogo(false);
                setanimation1(false);
                console.log("Scrolled Up - Animation1 reset");
            }
        })
        const Remove = () => {
            gsap.to(textinfo.current, {
                ...
                onComplete: (() => { showvid(true); console.log("Show vid") })
            })
        }
    ...
    return (
        <div ref={box} className=" h-full w-full relative">
            <div ref={box2} className=" absolute top-100 z-[120]               h-screen w-full left-0 right-0">

            </div>

            {/* text info part */}

            <div ref={box3} className=" absolute top-280  z-[120]               h-screen w-full left-0 right-0">
                <div ref={textinfo} className={` ${Animation1 ? "flex" : "hidden"} opacity-0 absolute md:top-2 -top-40 left-0 right-0 justify-center items-center flex-col gap-10 border-2`}>
                    <div className=" flex items-center justify-center flex-col gap-5 h-fit w-[99%]">
                        <h1 className=" text-[#9C2C64] md:text-7xl text-5xl">Vice City, USA.</h1>
                        <h2 className=" text-[#F07068] md:text-5xl text-4xl">Jason and Lucia have always known the deck is stacked against them. But when an easy score goes wrong, they find themselves on the darkest side of the sunniest place in America, in the middle of a criminal conspiracy stretching across the state of Leonida — forced to rely on each other more than ever if they want to make it out alive.</h2>
            ...
            <div ref={box4} className={` absolute md:top-400 top-450  z-[120]         h-screen w-full left-0 right-0`}>
                <div ref={vidtxt}  className=" flex absolute z-[120] m-20 md:ml-48 flex-col gap-3 items-start  ">
                    <h1 className=" font-semibold text-shadow-2xs text-shadow-black text-[#FFF9CB] md:text-7xl text-4xl">Dre'Quan Priest</h1>
                    <div className=" md:w-[50%] w-[99%] flex flex-col gap-3">
                    <h2 className=" md:text-4xl text-3xl font-bold text-[#FFFF7E]">Only Raw...Records</h2>
                    <h2 className="md:text-4xl text-xl font-bold text-white">Dre'Quan was always more of a hustler than a gangster. Even when he was dealing on the streets to make ends meet, breaking into music was the goal.</h2>
                    </div>
                </div>
                <div ref={vidref} className={` opacity-0 h-full w-full flex items-center justify-center sticky top-0`}>
                    <div className=" flex items-center justify-start">
                        <div className=" absolute z-[140] h-[100%]">
                            <img src="/hero2char.webp" className="h-full w-full object-cover" alt="" />
                        </div>
                    </div>
